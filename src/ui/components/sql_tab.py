...
class SQLTab:
    def __init__(self, notebook):
        ...
        # --- Grid weights ---
        self.frame.rowconfigure(0, weight=0)  # query fixed height
        self.frame.rowconfigure(1, weight=1)  # result table expands
        self.frame.rowconfigure(2, weight=0)  # buttons fixed height
